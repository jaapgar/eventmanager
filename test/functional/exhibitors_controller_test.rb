...
class ExhibitorsControllerTest < ActionController::TestCase
  ...
  test "should create exhibitor" do
    assert_difference('Exhibitor.count') do
      post :create, exhibitor: { description: @exhibitor.description, exhibitior_category_id: @exhibitor.exhibitior_category_id, name: @exhibitor.name, sponsor_id: @exhibitor.sponsor_id }
    end
  ...
  test "should update exhibitor" do
    put :update, id: @exhibitor, exhibitor: { description: @exhibitor.description, exhibitior_category_id: @exhibitor.exhibitior_category_id, name: @exhibitor.name, sponsor_id: @exhibitor.sponsor_id }
    assert_redirected_to exhibitor_path(assigns(:exhibitor))
  end
